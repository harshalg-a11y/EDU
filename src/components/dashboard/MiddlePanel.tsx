...
const generateConflictErrors = (): ConflictError[] => [
  {
    id: '1',
    type: 'critical',
    room: 'A101',
    timeSlot: '09:00 - 10:30 AM',
    conflict: 'Room double-booked with Physics Lab',
    resolved: false,
    resolving: false,
  },
  {
    ...
    conflict: 'Teacher overlap: Prof. Johnson assigned simultaneously',
    resolved: false,
    resolving: false,
  },
  {
    ...
    conflict: 'Capacity exceeded: 45 students in 30-seat room',
    resolved: false,
    resolving: false,
  },
  {
    ...
    conflict: 'Resource conflict: Projector unavailable',
    resolved: false,
    resolving: false,
  },
];
...
const GridCell: React.FC<GridCellProps> = ({ cell, onCellClick }) => {
  ...
  return (
    <motion.button
      ...
      className={`relative w-12 h-12 rounded border transition-all duration-200 cursor-pointer group ${getStatusColor()} ${getBorderColor()}`}
    ...
    >
      ...
      >
        <div className="bg-background border border-border rounded px-2 py-1 whitespace-nowrap text-xs text-white">
          {cell.room}
        </div>
      </motion.div>
    </motion.button>
    ...
    <AnimatePresence>
      {cell && (
        <>
          ...
          {/* Popover Card */}
          <motion.div
            className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 gemini-blur-card w-96 p-6"
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 p-3 rounded-lg bg-primary/5 border border-primary/20">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-white">{cell.teacher}</p>
                </div>
              </div>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mb-2">
            <p className="text-sm font-semibold text-white flex items-center gap-2">
              ...
              Room {error.room} • {error.timeSlot}
            </p>
          </div>
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          {!isResolved && (
            <motion.button
              ...
              className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-primary/20 hover:bg-primary/30 disabled:opacity-50 text-xs font-medium text-primary transition-colors"
    ...
    <div className="h-full w-full flex gap-6">
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded bg-rose-500/40 border border-rose-500/50" />
      ...
      <div className="w-96 flex flex-col">
        ...
        <div className="mb-4">
          ...
          <p className="text-xs text-muted-foreground mt-1">
            {conflicts.filter((c) => !c.resolved).length} active issues
          </p>
        </div>

        {/* Errors List - Scrollable */}
        <div className="flex-1 overflow-auto">
